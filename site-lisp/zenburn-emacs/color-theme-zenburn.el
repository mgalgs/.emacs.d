...
(defun color-theme-zenburn ()
  ...
  (color-theme-install
   `(color-theme-zenburn
     ...
     (match ((t (:background ,zenburn-blue-5 :foreground ,zenburn-orange :weight bold))))
     ;; (match ((t (:background ,zenburn-bg-1 :foreground ,zenburn-orange :weight bold))))

     ;; faces used by isearch
     (isearch ((t (:foreground ,zenburn-yellow :background ,zenburn-blue-5))))
